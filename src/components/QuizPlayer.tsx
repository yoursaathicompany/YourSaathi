...
export default function QuizPlayer({ quizId, questions, topic }: QuizPlayerProps) {
  ...
  if (result) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center text-center p-8 rounded-3xl border border-white/10 bg-[#18181b]">
        <motion.div
        ...
        <h2 className="text-4xl font-bold mb-2 text-white">Quiz Completed!</h2>
        ...
        <button
          onClick={() => router.push('/')}
          className="bg-[#121214] text-white font-bold px-8 py-3 rounded-xl hover:bg-white/10 transition-colors"
        >
          Back to Home
        </button>
    ...
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-4 px-3 py-1.5 bg-white/5 border border-white/10 rounded-full text-xs font-medium text-gray-400">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <div className="p-8 rounded-3xl border border-white/10 bg-[#18181b] mb-8">
          ...
          <div className="flex items-center justify-between">
            ...
            {isLastQuestion ? (
              ...
              <button
                ...
                className="bg-purple-600 hover:bg-purple-500 text-white px-10 py-3 rounded-xl font-bold transition-all flex items-center gap-2 disabled:opacity-50"
              >
