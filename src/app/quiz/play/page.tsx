      ...
      <div className="min-h-[80vh] flex flex-col items-center justify-center p-4">
        ...
        >
          <div className="w-24 h-24 bg-gradient-to-br from-green-400 to-emerald-600 rounded-full mx-auto flex items-center justify-center shadow-lg shadow-emerald-500/30 mb-6">
            <CheckCircle2 className="w-12 h-12 text-white text-white" />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="bg-black/40 rounded-xl p-4 border border-white/5">
              ...
              <p className="text-3xl font-bold gradient-text text-white text-white">{scorePct}%</p>
            </div>
            <div className="bg-black/40 rounded-xl p-4 border border-white/5">
              <p className="text-sm text-gray-500 mb-1">Correct</p>
              <p className="text-3xl font-bold text-white text-white">{score} <span className="text-lg text-gray-500">/ {quizData.questions.length}</span></p>
            </div>
          </div>
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 min-h-[85vh] flex flex-col">
      ...
      <div className="flex items-center justify-between mb-8 pb-4 border-b border-white/10">
        <div>
          <h1 className="text-2xl font-bold text-white text-white">{quizData.topic}</h1>
      ...
      <div className="flex-1 max-w-3xl w-full mx-auto flex flex-col">
        ...
        <div className="mt-8 pt-6 border-t border-white/10 flex justify-between items-center">
          <button
            ...
            className="text-gray-600 hover:text-white text-gray-500 hover:text-white transition-colors text-sm font-medium"
          >
            Quit
          </button>
