...
import { BrainCircuit, Beaker, Globe, Code2, Calculator, Book, Feather, Target, Trophy } from 'lucide-react';
...
export default function QuizBoxGrid() {
          ...
          return (
            ...
            >
              ...
              <div className="z-10 mt-2 flex-grow">
                <h3 className="text-xl font-bold text-white mb-1 group-hover:text-purple-400 transition-colors">{cat.name}</h3>
