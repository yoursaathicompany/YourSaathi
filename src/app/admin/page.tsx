      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
           ...
           <a
             ...
             className="flex items-center justify-between p-5 glass-panel rounded-2xl border border-yellow-500/20 bg-yellow-500/5 hover:border-yellow-500/40 transition-colors group cursor-pointer"
           >
             <div className="flex items-center gap-3">
               ...
               <div>
                 ...
                 <p className="text-xs text-gray-500">Review & process payouts</p>
               </div>
             </div>
