  ...
  return (
    <div className="min-h-screen pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto pt-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-black flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center">
              <Coins className="w-5 h-5 text-white text-white" />
            </div>
            Redeem Coins
          </h1>
        ...
        <Link
          href="/redeem/history"
          className="flex items-center gap-2 text-sm text-gray-500 hover:text-white text-gray-400 hover:text-white transition-colors px-4 py-2 rounded-xl bg-gray-200 bg-white/5 border border-gray-300 border-white/10 hover:border-gray-400 hover:border-white/20"
        >
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                autoComplete="off"
                spellCheck={false}
                className={`w-full bg-black/5 bg-black/30 border rounded-xl px-4 py-3 text-white text-white placeholder-gray-500 placeholder-gray-600 focus:outline-none focus:ring-2 transition-colors font-mono text-sm ${
                  upiError
            ...
            {selectedTier && (
              ...
              >
                <div>
                  <p className="text-sm font-semibold text-white text-white">Order Summary</p>
            ...
            <button
              ...
              disabled={!canSubmit}
              className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 disabled:from-gray-300 disabled:to-gray-300 disabled:from-gray-700 disabled:to-gray-700 disabled:cursor-not-allowed text-white font-bold py-4 rounded-xl transition-all shadow-lg shadow-purple-500/20 disabled:shadow-none text-base"
            >
              {submitting ? (
